    ...
    return (
      <React.Fragment>
        <div className="container" style={{padding: '24px'}}>
            <h2>Hour to Empower Terms of Use</h2>

              <p>Version 1.0</p>

              <p>The Hour to Empower website located at hourtoempower.org is a copyrighted work belonging to Hour to Empower. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>

              <p>All such additional terms, guidelines, and rules are incorporated by reference into these Terms.</p>

              <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. BY LOGGING INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have the authority and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 13 YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ANY OR ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</p>
              ...
              <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: 10751 Wilshire Blvd. Apt. 701, Los Angeles, CA. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
              ...
              <p>Address: 10751 Wilshire Blvd. Apt. 701, Los Angeles, CA</p>
              <p>Email: w.bertrand@hey.com</p>
          </div>
      </React.Fragment>
    );
  }
